...
import com.example.pharmacy_health_care.Admin.AdminDashboardActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void generateList(List<Items> body) {
        ...
        for (Items item: itemList){
            ...
            contactList.add(new Items(item.getName(),item.getDescription(),item.getImageName(),item.getPrice() ));
        }
